...
//#1
int64 nChainStartTime = 1495772021;
...
const string strMessageMagic = "DIVINECOIN Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in DIVINECOIN
    bool fStrictPayToScriptHash = true; // Always active in DIVINECOIN
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "DIVINECOIN", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        //#1
        const char* pszTimestamp = "DIVINECOIN created by SMITH 2017/05/25";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = nChainStartTime + 80;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
        //#1
        assert(block.hashMerkleRoot == uint256("0x9749637d5b05808e33d3e882ddbdcb2017ef9d07c5608ef8ebea6d1fce0b7e68"));
